...
class WaterRemindersPage extends StatelessWidget {
  const WaterRemindersPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.strings.waterReminders),
      ),
      body: Padding(
            ...
            Expanded(
              child: BlocBuilder<RemindersCubit, RemindersState>(
                builder: (context, state) {
                  ...
                  final notifications = state.waterNotifications;
