...
class BloodSugarRemindersPage extends StatelessWidget {
  const BloodSugarRemindersPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.strings.bloodSugarReminders),
      ),
      body: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
          children: [
            const BloodSugarReminderCard(),
            const Gap(16),
            Expanded(
              child: BlocBuilder<RemindersCubit, RemindersState>(
                builder: (context, state) {
                  ...
                  final notifications = state.bloodSugarNotifications;
