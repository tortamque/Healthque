...
class TemperatureReminderCard extends StatelessWidget {
  const TemperatureReminderCard({super.key});
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        child: const TemperatureReminderForm(),
      ),
    );
  }
}

class TemperatureReminderForm extends StatefulWidget {
  const TemperatureReminderForm({super.key});

  @override
  State<TemperatureReminderForm> createState() => _TemperatureReminderFormState();
}

class _TemperatureReminderFormState extends State<TemperatureReminderForm> {
  ...
  Future<void> _saveNotification() async {
    ...
    await context.read<RemindersCubit>().scheduleReminder(
          ...
          type: LocalNotificationType.temperature,
        );
