...
class WaterReminderForm extends StatefulWidget {
  ...
  @override
  State<WaterReminderForm> createState() => _WaterReminderFormState();
}
...
class _WaterReminderFormState extends State<WaterReminderForm> {
  ...
  Future<void> _saveNotification() async {
    ...
    await context.read<RemindersCubit>().scheduleReminder(
          ...
          type: LocalNotificationType.water,
        );
    if (!mounted) return;
    toastification.show(
      context: context,
    ...
    setState(() {
      _selectedTime = null;
      _titleController.text = context.strings.defaultReminderTitle;
      _bodyController.text = context.strings.defaultReminderBody;
    });
