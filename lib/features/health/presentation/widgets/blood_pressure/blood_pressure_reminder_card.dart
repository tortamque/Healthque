...
class BloodPressureReminderCard extends StatelessWidget {
  const BloodPressureReminderCard({super.key});
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        child: const BloodPressureReminderForm(),
      ),
    );
  }
}

class BloodPressureReminderForm extends StatefulWidget {
  const BloodPressureReminderForm({super.key});

  @override
  State<BloodPressureReminderForm> createState() => _BloodPressureReminderFormState();
}

class _BloodPressureReminderFormState extends State<BloodPressureReminderForm> {
