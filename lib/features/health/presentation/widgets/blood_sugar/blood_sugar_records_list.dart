...
class BloodSugarRecordsList extends StatelessWidget {
  const BloodSugarRecordsList({super.key});
    ...
    return BlocBuilder<BloodSugarTrackingCubit, BloodSugarTrackingState>(
      builder: (context, state) {
        ...
        if (records == null || records.records.isEmpty) {
          return Center(child: Text(context.strings.noBloodSugarMeasurements));
        }
            ...
            return Card(
              ...
              child: ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () async {
                    await context.read<BloodSugarTrackingCubit>().deleteBloodSugarRecord(record);
